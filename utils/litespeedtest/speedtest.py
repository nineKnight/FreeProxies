...
if __name__ == '__main__':
    ...
    parser.add_argument('--subscription', '-s', help='Subcription url or local file path', default='https://raw.githubusercontent.com/nineKnight/FreeProxies/master/sub/sub_merge_base64.txt')
